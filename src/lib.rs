...
pub struct HDWalletBip32 {
    ...
    pub bip32_root_key: String,
    pub bip32_root_pub_key: String,
    pub bip32_derivation_path: String,
    pub bip32_extended_private_key: String,
    pub bip32_extended_public_key: String,
...
pub struct HDWalletBip44 {
    ...
    pub account_extended_private_key: String,
    pub account_extended_public_key: String,
    pub derivation_path_external: String,
    pub bip32_extended_private_key_for_external: String,
    pub bip32_extended_public_key_for_external: String,
